...
public class BabyImgChangeActivity extends Activity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            // 返回
            case R.id.back:
                BabyImgChangeActivity.this.finish();
                break;
            // 提交
            case R.id.forward:
                if(bitmap == null)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
            ...
            image_path = getPath(BabyImgChangeActivity.this, uri);
